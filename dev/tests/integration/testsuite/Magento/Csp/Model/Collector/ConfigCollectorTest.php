...
class ConfigCollectorTest extends TestCase
{
     ...
     * @magentoConfigFixture default_store csp/policies/storefront/template/policy_id font-src
     * @magentoConfigFixture default_store csp/policies/storefront/template/none 0
     * @magentoConfigFixture default_store csp/policies/storefront/template/self 1
     * @magentoConfigFixture default_store csp/policies/storefront/template/inline 0
